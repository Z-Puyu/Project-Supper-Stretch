...
public static class ComponentExtensions {
    ...
    public static bool TryGetComponentInProperChildren<T>(this GameObject obj, [MaybeNullWhen(false)] out T component)
            where T : Component {
    ...
    public static bool TryGetComponentInProperChildren<T>(this Component self, [MaybeNullWhen(false)] out T component)
            where T : Component {
    ...
    public static bool TryGetComponentInProperParent<T>(this GameObject obj, [MaybeNullWhen(false)] out T component)
            where T : Component {
    ...
    public static bool TryGetComponentInProperParent<T>(this Component self, [MaybeNullWhen(false)] out T component)
            where T : Component {
