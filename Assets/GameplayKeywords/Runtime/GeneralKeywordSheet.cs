...
namespace GameplayKeywords {
    public abstract class GeneralKeywordSheet : ScriptableObject, ITraversable<KeywordSheetNode> {
        ...
        internal IEnumerable<AdvancedDropdownList<string>> Collate(bool all = false) {
