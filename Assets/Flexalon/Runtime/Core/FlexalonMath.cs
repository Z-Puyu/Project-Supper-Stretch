...
namespace Flexalon.Runtime.Core
{
    ...
    public static class Math
    {
        ...
        public static readonly Vector3 MaxVector = new Vector3(Math.MaxValue, Math.MaxValue, Math.MaxValue);
        ...
        {
            return Math.GetOppositeDirection((Direction)direction);
        }
        ...
        {
            return Math.GetAxisFromDirection((Direction)direction);
        }
        ...
        {
            return Math.GetDirectionsFromAxis((Axis)axis);
        }
        ...
        {
            return Math.GetPositiveFromDirection((Direction)direction);
        }
        ...
        {
            return Math.GetVectorFromDirection((Direction)direction);
        }
        ...
        {
            return Math.GetVectorFromAxis((Axis)axis);
        }
        ...
        {
            var other = Math.GetOtherAxes((Axis)axis);
        ...
        {
            var otherAxes = Math.GetOtherAxes(axis1);
        ...
        {
            return (int) Math.GetThirdAxis((Axis)axis1, (Axis)axis2);
        }
        ...
        {
            var axes = Math.GetPlaneAxes(plane);
        ...
        public static Bounds CreateRotatedBounds(Vector3 center, Vector3 size, Quaternion rotation)
        {
            ...
            var bounds = Math.RotateBounds(new Bounds(Vector3.zero, size), rotation);
        ...
        {
            if (align == global::Flexalon.Runtime.Core.Align.Start)
            {
                return -size * 0.5f;
            }
            else if (align == global::Flexalon.Runtime.Core.Align.End)
            {
                return size * 0.5f;
            }
        ...
        {
            return Math.Align(size[axis], align);
        }
        ...
        {
            return new Vector3(
                Math.Align(size, 0, horizontal),
                Math.Align(size, 1, vertical),
                Math.Align(size, 2, depth));
        }
        ...
        {
            return Math.Align(parentSize, parentAlign) - Math.Align(childSize, childAlign);
        }
        ...
        {
            return Math.Align(childSize, parentSize, align, align);
        }
        ...
        {
            return Math.Align(childSize[axis], parentSize[axis], align);
        }
        ...
        {
            return Math.Align(childSize, parentSize, (int)axis, align);
        }
        ...
        {
            return Math.Align(childSize[axis], parentSize[axis], parentAlign, childAlign);
        }
        ...
        {
            return Math.Align(childSize, parentSize, (int)axis, parentAlign, childAlign);
        }
        ...
        {
            return Math.Align(parentSize, parentHorizontal, parentVertical, parentDepth) -
                Math.Align(childSize, childHorizontal, childVertical, childDepth);
        }
        ...
        {
            return Math.Align(parentSize, horizontal, vertical, depth) -
                Math.Align(childSize, horizontal, vertical, depth);
        }
